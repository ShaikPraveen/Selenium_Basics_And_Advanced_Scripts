...
public class Handling_Multiple_Fileuploads {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.id("photofile")).click();
		Runtime.getRuntime().exec("D:\\Praveen_Automation\\Autoit_Programs\\gmailerror.exe");
		System.out.println("File Second Uploaded Successfully");
